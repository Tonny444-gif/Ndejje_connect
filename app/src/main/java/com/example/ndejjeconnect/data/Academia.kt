...
object Academia {
    ...
    val academicStructure: Map<String, Map<String, Map<String, List<String>>>> = mapOf(
        "Faculty of Science and Computing" to getScienceAndComputingData(),
        "Faculty of Engineering and Survey" to getEngineeringAndSurveyData(),
        "Faculty of Business Administration and Management" to getBusinessData(),
        "Faculty of Humanities and Education" to getHumanitiesData(),
        "Faculty of Social Sciences and Arts" to getSocialSciencesData(),
        "Faculty of Environment and Agricultural Sciences" to getEnvironmentData(),
        "Faculty of Health Sciences" to getHealthSciencesData(),
        "The Graduate School" to getGraduateSchoolData()
    )

    private fun getScienceAndComputingData() = mapOf(
    ...
    private fun getEngineeringAndSurveyData() = mapOf(
        "Bachelor's Degree" to mapOf(
    ...
    private fun getBusinessData() = mapOf(
        "Bachelor's Degree" to mapOf(
    ...
    private fun getHumanitiesData() = mapOf(
        "Bachelor's Degree" to mapOf(
    ...
    private fun getSocialSciencesData() = mapOf(
        "Bachelor's Degree" to mapOf(
    ...
    private fun getEnvironmentData() = mapOf(
        "Bachelor's Degree" to mapOf(
    ...
    private fun getHealthSciencesData() = mapOf(
        "Bachelor's Degree" to mapOf(
    ...
    private fun getGraduateSchoolData() = mapOf(
        "Certificate" to mapOf(
